...
;(function() {
  ...
  z.iL = (function() {
    ...
    a.prototype = {
      ...
      move: function(a) {
        ...
        na(a)
        this.oh || ((a = document.createEvent('Event')), a.initEvent('tap', t, q), this.element.dispatchEvent(a))
  ...
  z.extend(Ka.prototype, {
    ...
    Gg: function(a, b) {
      if (Wa(a) && (this.bv(), this.dispatchEvent(new P('onzoomstart')), (a = this.Yn(a).zoom), a !== this.Oa)) {
        ...
        c && ((c = this.$b(c, this.Oc)), this.ik(this.width / 2 - c.x, this.height / 2 - c.y, this.xb(c, this.Oc), q))
    ...
    qi: function(a) {
      a instanceof J &&
        ((this.fc = this.cd.vj(a, this.Ub)), (this.re = J.yM(a) ? new J(a.lng, a.lat) : this.cd.nh(this.fc, this.Ub)))
    },
    Ag: function(a, b) {
      a = Math.round(a) || 0
      b = Math.round(b) || 0
    ...
    void (function(a, b, c) {
      ...
      p &&
        ...
        (c.alog('cus.on', 'time', function(a) {
          ...
          if ('[object Object]' === a.toString()) {
            for (var i in a)
              'page' == i ? (b.page = a[i]) : ((f = parseInt(a[i])), 0 < f && /^z_/.test(i) && ((e = q), (b[i] = f)))
        ...
        c.alog('cus.on', 'count', function(a) {
          ...
          if (a instanceof Array)
            for (var f = 0; f < a.length; f++)
              /^z_/.test(a[f]) ? ((e = q), (b[a[f]] = 1)) : /^page:/.test(a[f]) && (b.page = a[f].substring(5))
      ...
      if (v && v.wh && m() < v.wh) {
        var C = ['Moz', 'O', 'ms', 'Webkit'],
          ...
          Ii = function() {
            return (
              !!a.webkitNotifications || ('Notification' in a && 'permission' in a.PP && 'requestPermission' in a.PP)
            )
          },
          Ji = function() {
  ...
  z.object.extend(fc.prototype, {
    ...
    removeItem: function(a) {
      if (a && 'menuitem' == a.Mb) {
        ...
        b = 0
        for (c = this.Kf.length; b < c; b++) this.Kf[b] === a && (this.Kf[b].remove(), this.Kf.splice(b, 1), c--)
      }
    },
    bC: function() {
      this.xa.push({
  ...
  z.extend(S.prototype, {
    ...
    xb: function(a, b, c, e, f) {
      if (a)
        return (b = this.dc(b)), this.nh(new J(c.lng + b * (a.x - e.width / 2), c.lat - b * (a.y - e.height / 2)), f)
    },
    dc: function(a) {
    ...
    qv: function(a, b) {
      ...
      for (
        ...
        var k = (Math.PI / 180) * i,
          ...
          k = new J(
            (((g -
              Math.atan2(Math.sin(k) * Math.sin(e) * Math.cos(f), Math.cos(e) - Math.sin(f) * Math.sin(m)) +
              Math.PI) %
              (2 * Math.PI)) -
              Math.PI) *
              (180 / Math.PI),
      ...
      for (e = this.hc.length; n < e; n++)
        (C = this.hc[n][0]),
          ...
          o
            ...
            : (0 < this.Dc.length
                ? ((o = this.Dc.shift()), o.getContext('2d').clearRect(-c / 2, -c / 2, y, y), (p = o.style))
      ...
      for (var i = 0; i < c; i++) {
        ...
        if (k.Jw) {
          ...
          if (a) {
            var n = m
            if (n && n.childNodes)
              for (var o = n.childNodes.length, p = o - 1; 0 <= p; p--) (o = n.childNodes[p]), n.removeChild(o), (o = s)
          }
          if (this.map.Sb()) {
  ...
  z.extend(Mc.prototype, {
    ...
    getTilesUrl: function(a, b) {
      ...
      this.vf.tileUrlTemplate &&
        ((e = this.vf.tileUrlTemplate.replace(/\{X\}/, c)), (e = e.replace(/\{Y\}/, a.y)), (e = e.replace(/\{Z\}/, b)))
      return e
    },
    pm: w('mW'),
    oa: function() {
  ...
  z.extend(qe, {
    ...
    BS: function(a, b, c, e) {
      ...
      f.push(e)
      f.push(
        "<div id='infoWndPano' class='panoInfoBox' style='height:" + i + 'px;width:' + g + "px; margin-top: -19px;'>"
      )
      f.push(
  ...
  Ye.prototype = {
    ...
    Ar: function(a, b) {
      this.al ||
        ...
        this.options.Yk
          ...
          : ((a = ue.round(a)), (b = ue.round(b)), (this.Nb.style.left = a + 'px'), (this.Nb.style.top = b + 'px')),
        (this.x = a),
        (this.y = b),
        this.AB('h'),
        this.AB('v'))
    ...
    zT: function(a) {
      ...
      if (this.options.zoom && Me && 1 < a.touches.length)
        ...
        ;(6 > this.uw && 6 > this.vw) ||
          (this.options.OE &&
            (this.uw > this.vw + 5 ? ((g = this.y), (e = 0)) : this.vw > this.uw + 5 && ((f = this.x), (c = 0))),
          (this.oh = q),
          this.Ar(f, g),
  ...
  B.Tm(function(a) {
    ...
    a.addEventListener('position_changed', function() {
      a.j.visible && a.j.albumsControl === q && (b ? b.Ey(a.Xb()) : ((b = new Ze(a.j.albumsControlOptions)), b.na(a)))
    })
    a.addEventListener('albums_visible_changed', function() {
      a.j.albumsControl === q ? (b ? b.Ey(a.Xb()) : ((b = new Ze(a.j.albumsControlOptions)), b.na(a)), b.show()) : b.U()
    })
  ...
  z.extend(Ze.prototype, {
    ...
    Il: function(a) {
      ...
      var b = this.LX(a)
      Ua() &&
        (this.Ji && 0 < this.Ji.length && this.j.showExit && this.hA) &&
    ...
    wQ: function() {
      ...
      z.M(this.gk, 'click', function(b) {
        if ((b = (b.srcElement || b.target).getAttribute('data-index')) && b != a.Zc) a.Mp(b), a.P.vc(a.bk[b].panoId)
      })
